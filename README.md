...
In practice, you would usually consume the events using the
...
Returns a promise that resolves when all the event listeners are done. _Done_ meaning executed if synchronous or
